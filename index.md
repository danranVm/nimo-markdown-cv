...
- 能够使用 Vue/Angular 相关技术栈独立完成整个 Web 前端系统开发
- 有从 0 到 1 搭建前端工程化体系以及封装完整组件库的能力
- Js 基础扎实，有信心在一周内上手主流前端框架(React, Svelte等)
- 对后端以及数据库有一定了解，能看懂和编写一些 CURD 接口

## 工作经历

### 深信服科技股份有限公司`2020.03 - 至今`
...
- iDux 开源组件库：是一套企业级中后台 UI 组件库, 基于 Vue 3.x + TypeScript 开发
  - 项目地址：https://github.com/IDuxFE/idux
  - 包含了 10+ CDK 和 50+ 基础组件，可以满足大部分企业级应用的常规需求开发
  - 从 0-1 搭建 CI/CD， 整个项目模板和大部分的组件核心代码的编写

- API 自动化平台：利用 Open API 规范，实现前端接口请求代码的自动生成
  - 支持 Swagger, Open API 2.0/3.0 以及 eolinker 等多种格式
  - 支持高度自定义模板，无缝接入业务项目

- AI Review 工具：利用 chatGPT 的能力，对代码进行自动 review
  - 降低人工 Review 的成本 70%
  - 问题发现率相比人工提升 50%

- 多个产品的业务代码维护，大多数为 Web 控制台应用，也有一部分 electron 应用
...
- 金证综合运营平台：为证券公司提供统一后台各业务系统的终端，构建统一的员工工作平台。实现集中化对员工岗位权限、业务相关参数、营业部等分支机构的统一管理、对平台及各业务系统参数进行统一配置与管理，降低运营成本与难度。
...
- Html 模板设计器： 一个为金证综合运营平台的影像系统所服务的桌面程序。通过拖拉拽组件的方式，设计、生成出可以支持数据渲染的 Html 模板文件，得到相应的可以渲染数据的表单。
